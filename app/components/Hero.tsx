    ...
    <section id="hero" className={`relative min-h-screen pt-20 md:pt-24 pb-16 ${isLight ? 'bg-white' : 'bg-bg-primary'} ${isLight ? '' : 'mesh-gradient'}`}>
      <div className="max-w-[1200px] mx-auto px-6 md:px-8 lg:px-12 flex flex-col items-center text-center lg:flex-row lg:text-left lg:justify-between gap-12 lg:gap-32 lg:items-center" style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left max-w-2xl lg:flex-1">
          ...
          >
            Full-Stack Developer <span className="mx-2 text-slate-400 font-light">|</span> React Specialist
          </motion.h2>
          ...
          >
            <a
              ...
              className={`group flex items-center justify-center w-14 h-14 rounded-full border transition-all hover:scale-110 ${
                isLight
            ...
            >
              <svg viewBox="0 0 24 24" className={`w-6 h-6 ${isLight ? 'text-black' : 'text-white'} group-hover:text-white transition-colors`} fill="currentColor">
            ...
            <a
              ...
              aria-label="GitHub"
            >
              <svg viewBox="0 0 24 24" className={`w-6 h-6 transition-colors ${isLight ? 'text-[#24292e]' : 'text-gray-300'} group-hover:text-white`} fill="currentColor">
            ...
            <a
              ...
              aria-label="LinkedIn"
            >
              <svg viewBox="0 0 24 24" className={`w-6 h-6 ${isLight ? 'text-[#0A66C2]' : 'text-[#0A66C2]'} group-hover:text-white transition-colors`} fill="currentColor">
